...
export type ResolversTypes = {
  ...
  CursorPaginatedPosts: ResolverTypeWrapper<
    Omit<CursorPaginatedPosts, "node"> & {
      node?: Maybe<ResolversTypes["CursorPaginatedPostsNode"]>;
    }
  >;
  CursorPaginatedPostsNode: ResolverTypeWrapper<
    Omit<CursorPaginatedPostsNode, "edges"> & {
      edges?: Maybe<Array<Maybe<ResolversTypes["Post"]>>>;
    }
  >;
  ...
  OffsetPaginatedPosts: ResolverTypeWrapper<
    Omit<OffsetPaginatedPosts, "nodes"> & {
      nodes?: Maybe<Array<Maybe<ResolversTypes["Post"]>>>;
    }
  >;
...
export type ResolversParentTypes = {
  ...
  CursorPaginatedPosts: Omit<CursorPaginatedPosts, "node"> & {
    node?: Maybe<ResolversParentTypes["CursorPaginatedPostsNode"]>;
  };
  CursorPaginatedPostsNode: Omit<CursorPaginatedPostsNode, "edges"> & {
    edges?: Maybe<Array<Maybe<ResolversParentTypes["Post"]>>>;
  };
  CursorPaginatedPostsPageInfo: CursorPaginatedPostsPageInfo;
  DateTime: Scalars["DateTime"];
  Int: Scalars["Int"];
  Mutation: {};
  OffsetPaginatedPosts: Omit<OffsetPaginatedPosts, "nodes"> & {
    nodes?: Maybe<Array<Maybe<ResolversParentTypes["Post"]>>>;
  };
...
export type CursorPaginatedPostsResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes["CursorPaginatedPosts"]
> = {
  message?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
  node?: Resolver<
    Maybe<ResolversTypes["CursorPaginatedPostsNode"]>,
    ParentType,
    ContextType
  >;
...
export type CursorPaginatedPostsNodeResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes["CursorPaginatedPostsNode"]
> = {
  edges?: Resolver<
  ...
  >;
  page_info?: Resolver<
    Maybe<ResolversTypes["CursorPaginatedPostsPageInfo"]>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CursorPaginatedPostsPageInfoResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes["CursorPaginatedPostsPageInfo"]
> = {
  end_cursor?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
...
> = {
  createAccount?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreateAccountArgs, "email" | "username">
  >;
};

export type OffsetPaginatedPostsResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes["OffsetPaginatedPosts"]
> = {
  meta?: Resolver<
    Maybe<ResolversTypes["OffsetPaginatedPostsMeta"]>,
    ParentType,
    ContextType
  >;
  nodes?: Resolver<
...
export type OffsetPaginatedPostsMetaResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes["OffsetPaginatedPostsMeta"]
> = {
...
> = {
  getPostsCursorPagination?: Resolver<
    Maybe<ResolversTypes["CursorPaginatedPosts"]>,
    ParentType,
    ContextType,
    RequireFields<QueryGetPostsCursorPaginationArgs, "limit">
  >;
  getPostsOffsetPagination?: Resolver<
    Maybe<ResolversTypes["OffsetPaginatedPosts"]>,
    ParentType,
    ContextType,
    RequireFields<QueryGetPostsOffsetPaginationArgs, "limit" | "page">
  >;
